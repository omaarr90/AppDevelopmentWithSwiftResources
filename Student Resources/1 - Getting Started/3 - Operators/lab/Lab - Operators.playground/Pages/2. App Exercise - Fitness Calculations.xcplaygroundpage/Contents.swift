...
print("averageHRD and averageHR are different becuase thier types are different. averageHR is Int and averageHRD is Double")
print("Double types can store floating points while Int types store whole numbers")
/*:
