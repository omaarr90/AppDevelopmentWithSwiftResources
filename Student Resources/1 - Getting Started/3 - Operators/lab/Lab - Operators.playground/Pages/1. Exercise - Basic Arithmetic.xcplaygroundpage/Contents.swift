 ...
 */
print("The divison of 10 divided by three should 3.3333 but since the result will be Int, then it should be 3")
let integerDivisionResult = 10 / 3
print("The actual result is: \(integerDivisionResult)")
/*:
...
print("Dividing Int by Int will result in an Int.")
print("Dividing Double by Double will result in a Double.")
/*:
